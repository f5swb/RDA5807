...
#include "Nextion.h"
#include <EEPROM.h>
int adresse = 14; //adress to read where the frequency memory is written 
...
// Declare a button object [page id:4,component id:10, component name: "buttonRssi"].
...
void setup() {
    ...
    nexInit();
    page1.show();
    rx.setFrequency(frequence);  // Tune on frequence MHz
